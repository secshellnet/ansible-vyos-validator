...
def check_duplicate_numbers(name: str, rules: list[dict], key_name: str = "number") -> bool:
    """
...
def check_firewall_rule(site: str, afi: str, ruleset_name: str, rule: dict):
    """
...
def check_source_group(site: str, afi: str, source_group_name: dict, rule_number: str, ruleset_name: str) -> bool:
    """
